        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 space-y-10">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed text-justify">
              Ao acessar e utilizar o site da <strong>Gaspar Multimarcas</strong>, você concorda em cumprir e estar vinculado aos seguintes termos e condições de uso. Se você não concordar com qualquer parte destes termos, por favor, não utilize nosso site.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed text-justify">
              <p>
                A Gaspar Multimarcas se esforça para garantir que todas as informações (preços, especificações, fotos e descrições) exibidas no site sejam precisas e atualizadas. No entanto, erros podem ocorrer.
              </p>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed text-justify mb-4">
              Todos os veículos vendidos pela Gaspar Multimarcas seguem rigorosamente as determinações do Código de Defesa do Consumidor (Lei nº 8.078/1990).
            </p>
            <p className="text-gray-600 leading-relaxed text-justify">
